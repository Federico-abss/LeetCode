<h2>895. Maximum Frequency Stack</h2><h3>Hard</h3><hr><div><p>Implement <code>FreqStack</code>, a class which simulates the operation of a stack-like data structure.</p>
