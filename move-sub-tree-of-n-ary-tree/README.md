<h2>1516. Move Sub-Tree of N-Ary Tree</h2><h3>Hard</h3><hr><div><p>Given the <code>root</code> of an&nbsp;<a href="https://leetcode.com/articles/introduction-to-n-ary-trees/">N-ary tree</a>&nbsp;of unique values, and two nodes of the tree&nbsp;<code>p</code> and <code>q</code>.</p>
...
<pre><strong>Input:</strong> root = [1,null,2,3,null,4,5,null,6,null,7,8], p = 2, q = 7
...
<pre><strong>Input:</strong> root = [1,null,2,3,null,4,5,null,6,null,7,8], p = 1, q = 2
